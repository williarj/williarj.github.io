...
* Date: F Dec 1
* Readings: 
  * 📖 [GEVE](#texts) Chapter 1 (~45 pages)
  * Our first reading from the book, check the book section below for a link
...
* Readings: 
  * [12] Pasyukova EG, et al. 2004. [Accumulation of Transposable Elements in the Genome of Drosophila melanogaster is Associated with a Decrease in Fitness.](https://doi.org/10.1093/jhered/esh050) J Hered.
  * [12] Charlesworth B & Charlesworth D. 2009. [The population dynamics of transposable elements.](https://doi.org/10.1017/S0016672300021455) Genet Res.
  * [13] Lee YCG & Langley CH. 2010. [Transposable elements in natural populations of Drosophila melanogaster.](https://royalsocietypublishing.org/doi/abs/10.1098/rstb.2009.0318) Phil Trans B.
...
* Readings: 
  ...
  * This is our final reading from GEVE
...
* ❗ **Due: 🎲 [Video Introduction](/BIO491_conflict/ProjectVideo) to the Game. 5pm Friday** Post a link to the video in the instruction manual for your game. Make sure this is updated on github.
...
This book is provided online by the Logan Library at [this link.](https://go.openathens.net/redirector/rose-hulman.edu?url=https://doi.org/10.1093/oso/9780198862260.001.0001) You can read it online or download a pdf.
...
Each student begins the quarter with <u>two tokens</u>, these are a second chance opportunity. They can be used on any *individual* assignment, submission, or activity throughout the quarter. If you are using a token you are expected to inform me within 2 days of the associated assessment item's normal due date (unless otherwise specified). 
...
<!-- removed 2324b [Conflict Minute](ConflictMinute) -->
