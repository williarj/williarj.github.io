...
assumed genetics (Ch 4 and Ch 5)

1. Week 1
   * Reading: 
   * historical perspective - previous ideas (gradualism, fossils, lamarc) Ch 2, Ch 17/18 -- find some summary from WEIT
   * HWE review and major forces -- Ch 6
     * evolution as an algorithm
     * fitness
2. Week 2
   * Reading: Ch 7
   * Drift 1 (randomness)
   * Drift 2 (buri paper and experimental design)
3. Week 3
   * Reading: 
   * mutation (first changes to math) Ch 6.4
   * migration & differentiation (F introduced) Ch 7
4. Week 4
   * Reading: 
   * selection (delta p, directional, balancing, stabilizing) Ch 6
   * selection 2 (lewontin and hubby, dominance, post -- examples of dominance or s estimates in recent work)
5. Week 5
   * Reading: Ch 11
   * Sexual selection (female choice)
   * Sexual selection (male competition)
   * Submit review topic proposals
6. Week 6
   * Reading: 
   * heredity (Galton height data, consider how it affects response to selection) (ch 9)
   * evolution of sex Ch 8.3 (recombination, red queen, Aneil papers)
7. Week 7
   * Reading: 
   * adaptation (weiss drought paper, how do we test for adaptation -- post examples) Ch 10
   * adaptation 2 (sweeps) (signals of sweeps in diversity data -- pi analogous to heterozygosity)(examples, and complexities, sickle cell, lactase, altitude genes, foxp2) Ch 15
   * Submit review draft
8. Week 8
   * Reading: 
   * population differentiation (how do populations become different? - reminder about F statistics, measuring inbreeding, inbreeding depression)
   * population differentiation (great wall plant data, how different are human populations, some structured populations of interest -- seagulls? guppies?)
9. Week 9
   * Reading: 
   * speciation (BDMI, barriers to reproduction, maybe some math of these dynamics) Ch 16
   * altruism? (or speciation 2; ch 12)
10. Week 10
    * Reading: papers
    * epigenetics (sweden paper, some newer stuff, how to test these and being careful in science)
    * non-biological evolution (linguistics, software selection, etc post some examples)
    * Submit review final
...
Supplied primary literature

Why Evolution is True

<h5>Reading effectively</h5>

Book should help frame, and connect some ideas we don't have time in class to do. 

Other readings will be assumed you have read them before class they are assigned, they will be provided at least one class in advance. 
...
<--
Things to include for students reviews: summary of article and main arguments, suggest at least one new reference to add, assess the figures.
-->

*Response to Reviewers (10%)*
Based on the feedback from your reviewers and the editor you will make changes to your submission and write a response to the reviewers. [Here is another Elsevier article](https://www.elsevier.com/connect/authors-update/how-to-respond-to-reviewer-comments-the-calm-way) about responding to reviewers you should read before hand. You will be assessed by how well you incorporate and respond to reviewer feedback. Remember: you *do not* have to make every change reviewers propose, but you must make a reasonable argument about why you are not making their proposed changes in your response.
...
<h5>Formatting guidelines</h5>

Assignments will be submitted and returned via gradescope, the link and instructions for our gradescope page can be found on moodle. In general, assignments should be submitted as a pdf, in 12 point Arial font, they should always include your name and CM# on the first page. 
...
If you have any concerns about any course matters, you should tell someone. You can email your instructor, speak to your instructor, or leave anonymous feedback in Moodle. You can also contact the [department head](mailto:mellor@rose-hulman.edu), [Student Affairs](https://www.rose-hulman.edu/campus-life/student-affairs/index.html), or another Rose employee you feel comfortable with.
